...
Window {
    ...
    property real baseW: 900
    property real baseH: 850

    property real uiScale: Math.min(width / baseW, height / baseH)

    property real dpr: (screen ? screen.devicePixelRatio : 1.0)
    property real hairline: Math.max(1.0 / uiScale, 1.0 / (uiScale * dpr))
    ...
    Item {
        id: scaledRoot
        width: configWindow.baseW
        height: configWindow.baseH
        anchors.centerIn: parent

        scale: configWindow.uiScale
                ...
                RowLayout {
                    ...
                    GroupBox {
                        ...
                        background: Rectangle {
                            ...
                            border.width: configWindow.hairline
